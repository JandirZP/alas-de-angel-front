...
export const AddMorePathologies: React.FC<AddPathologyProps> = ({ visible, onClose, onAdd }) => {
    ...
    return (
        <Modal visible={visible} onClose={onClose}>
            <div className="p-4">
                <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-orange-300 pb-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-slate-300 rounded-lg px-3 py-2 outline-none focus:border-orange-500"
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-orange-300">
                        ...
                        <button type="submit" className="px-5 py-2 font-semibold text-white bg-orange-600 rounded-lg hover:bg-orange-700">Guardar Patología</button>
                    </div>
                </form>
            </div>
        </Modal>
