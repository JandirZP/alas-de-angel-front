...
interface AddDrugsProps {
    visible: boolean;
    onClose: () => void;
    onAdd: (drug: Omit<HistorialDrogas, 'id' | 'historiaClinicaId'>) => void;
}

export const AddMoreDrugs: React.FC<AddDrugsProps> = ({ visible, onClose, onAdd }) => {
    ...
    return (
        <Modal visible={visible} onClose={onClose}>
            <div className="p-4">
                <h2 className="text-2xl font-bold text-slate-800 mb-6 border-b border-rose-300 pb-2">
                    <i className="fa-solid fa-hand-dots text-rose-500 mr-2"></i> Agregar Droga Ilícita
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-slate-300 rounded-lg px-3 py-2 outline-none focus:border-rose-500"
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-rose-300">
                        ...
                        <button type="submit" className="px-5 py-2 font-semibold text-white bg-rose-600 rounded-lg hover:bg-rose-700">Guardar Droga</button>
                    </div>
                </form>
            </div>
        </Modal>
