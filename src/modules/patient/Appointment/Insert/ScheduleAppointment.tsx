...
export const ScheduleAppointment = ({ paciente, onCitaAgendada, onCancel }: Props) => {
      ...
      >
        ...
        <div className="flex gap-4">
          <button
            ...
            onClick={onCancel}
            disabled={guardando}
            className="w-1/3 bg-slate-200 hover:bg-slate-300 disabled:bg-slate-100 disabled:text-slate-400 text-slate-700 py-2 rounded-lg font-medium transition"
          >
            Cancelar
          </button>
          <button
            type="submit"
            disabled={guardando}
            className="w-2/3 bg-sky-600 hover:bg-sky-700 disabled:bg-sky-400 disabled:cursor-not-allowed text-white py-2 rounded-lg font-medium transition"
          >
            {guardando ? (
